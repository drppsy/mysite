...
class GoodsCategory(models.Model):
    ...
    parent_category = models.ForeignKey("self",null=True,blank=True,on_delete=models.DO_NOTHING,verbose_name="父类目级别",\
...
class GoodsCategoryBrand(models.Model):
    ...
    name = models.CharField(default="",max_length=30,verbose_name="品牌名",help_text="品牌")
...
class GoodsImage(models.Model):
    ...
    商品轮播图
    '''
    goods = models.ForeignKey(Goods,verbose_name="商品",on_delete=models.DO_NOTHING,related_name="images")
